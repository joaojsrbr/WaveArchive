...
type Build struct {
	...
	NormalAttackLevel   int         `json:"normalAttackLevel"`
	ResonanceSkillLevel int         `json:"resonanceSkillLevel"`
	ForteLevel          int         `json:"forteLevel"`
	LiberationLevel     int         `json:"liberationLevel"`
	IntroLevel          int         `json:"introLevel"`
